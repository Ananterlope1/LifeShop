...
ALifeShopCharacter::ALifeShopCharacter()
{
...
void ALifeShopCharacter::BeginPlay()
{
	// Call the base class  
	Super::BeginPlay();
...
void ALifeShopCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = CastChecked<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		//Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &ALifeShopCharacter::Move);
...
void ALifeShopCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void ALifeShopCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
